        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DegisenTabloAdi = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DegisenAlanAdi = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EskiDeger = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    YeniDeger = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AyrilisSebep = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IsBasvuruDetayAlanlari_IsBasvuruDetayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IsBasvuruDetayDepartmanlari_IsBasvuruDetayId",
                table: "IsBasvuruDetayDepartmanlari",
                column: "IsBasvuruDetayId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IsBasvuruDetayOyunlari_IsBasvuruDetayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IsBasvuruDetayProgramlari_IsBasvuruDetayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IsBasvuruDetaySubeler_IsBasvuruDetayId",
