...
namespace IsBasvuru.WebAPI.Controllers
{
    ...
    public class DepartmanPozisyonController : BaseController
    {
        ...
        public DepartmanPozisyonController(IDepartmanPozisyonService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(DepartmanPozisyonCreateDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(DepartmanPozisyonUpdateDto dto)
        {
