...
namespace IsBasvuru.WebAPI.Controllers
{
    ...
    [ApiController]
    public class DigerKisiselBilgilerController : BaseController // 1. BaseController'dan miras al
    {
        private readonly IDigerKisiselBilgilerService _service;

        public DigerKisiselBilgilerController(IDigerKisiselBilgilerService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(DigerKisiselBilgilerCreateDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(DigerKisiselBilgilerUpdateDto dto)
        {
