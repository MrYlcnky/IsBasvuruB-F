...
[ApiController]
[Authorize]
public class ReferansBilgisiController : BaseController
{
    private readonly IReferansBilgisiService _service;
    public ReferansBilgisiController(IReferansBilgisiService service) { _service = service; }
    ...
    [HttpPost("Create")]
    [AllowAnonymous]
    public async Task<IActionResult> Create([FromBody] ReferansBilgisiCreateDto dto)
    {
    ...
    [HttpPut("Update")]
    public async Task<IActionResult> Update([FromBody] ReferansBilgisiUpdateDto dto)
    {
